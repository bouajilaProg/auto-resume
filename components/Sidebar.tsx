  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0 shrink-0 z-50">
      ...
      <Link href="/main" className="h-20 flex items-center gap-4 px-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
        ...
        <span className="font-black text-xl tracking-tight text-gray-900 uppercase">AutoResume</span>
      </Link>
        ...
        <nav className="space-y-1">
          {navItems.map((item) => (
            ...
            >
              ...
              {item.active && <div className="w-1.5 h-1.5 rounded-full bg-primary-600" />}
            </Link>
          ))}
        </nav>
